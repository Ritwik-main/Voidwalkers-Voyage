...
#modify item
data modify storage stellarity:temp object set from entity @s SelectedItem
...
item modify entity @s weapon.mainhand stellarity:append_durability_lore
...
execute if score $player.out_0 stellarity.misc matches 0 run item replace entity @s weapon.mainhand with minecraft:air
