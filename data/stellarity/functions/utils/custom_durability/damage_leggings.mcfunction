...
#modify item
data modify storage stellarity:temp object set from entity @s Inventory[{Slot:101b}]
...
item modify entity @s armor.legs stellarity:append_durability_lore
...
execute if score $player.out_0 stellarity.misc matches 0 run item replace entity @s armor.legs with minecraft:air
