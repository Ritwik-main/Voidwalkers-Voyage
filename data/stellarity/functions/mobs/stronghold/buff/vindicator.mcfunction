...
execute if predicate stellarity:utils/chance/33percent run item replace entity @s weapon.offhand with shield

tag @s add stellarity.stronghold.buffed

attribute @s generic.armor modifier add 39147e49-acc7-4a91-96f1-af1c41b25e0d "stellarity.stronghold_defense_buff" 3 add
attribute @s generic.attack_damage modifier add 535599d2-8bd7-4b6d-9596-71a966be01f2 "stellarity.stronghold_attack_buff" 0.5 multiply_base
