...
execute if score @s stellarity.eol.projectile_age matches 21..35 facing entity @p eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^7 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.5 ~ ~
execute if score @s stellarity.eol.projectile_age matches 35..60 facing entity @p eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^9 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.5 ~ ~
execute if score @s stellarity.eol.projectile_age matches 61.. run tp @s ^ ^ ^0.5 ~ ~
