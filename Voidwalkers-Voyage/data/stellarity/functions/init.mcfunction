...
execute unless score #reload stellarity.misc matches 1.. unless score #stellarity.config stellarity.config.join_message matches 1 run schedule function stellarity:tellraw 5t
