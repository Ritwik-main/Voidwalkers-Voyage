...
execute if predicate stellarity:utils/chance/25percent run item replace entity @s weapon with iron_sword
...
attribute @s minecraft:zombie.spawn_reinforcements modifier add 4d5f1512-cde2-4447-af41-fd07eecf427c "stellarity.spawn_reinforcements" 0.11 add
