...
execute if score out stellarity.misc matches 1 run data modify storage stellarity:temp villager_trades append value {maxUses:9,rewardExp:1b,priceMultiplier:0.3,demand:12,specialPrice:0,buy:{id:"emerald",Count:64,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"mojang_banner_pattern",Count:1,tag:{}}}
execute if score out stellarity.misc matches 2 run data modify storage stellarity:temp villager_trades append value {maxUses:9,rewardExp:1b,priceMultiplier:0.3,demand:12,specialPrice:0,buy:{id:"emerald",Count:16,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"globe_banner_pattern",Count:1,tag:{}}}
