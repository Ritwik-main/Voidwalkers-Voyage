...
execute if score out stellarity.misc matches 1 run data modify storage stellarity:temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:40,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_helmet",Count:1,tag:{}}}
execute if score out stellarity.misc matches 1 run data modify storage stellarity:temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:64,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_chestplate",Count:1,tag:{}}}
execute if score out stellarity.misc matches 2 run data modify storage stellarity:temp villager_trades append value {maxUses:3,rewardExp:1b,priceMultiplier:0.2,demand:3,specialPrice:0,buy:{id:"emerald",Count:48,tag:{}},buyB:{id:"air",Count:1,tag:{}},sell:{id:"diamond_leggings",Count:1,tag:{}}}
