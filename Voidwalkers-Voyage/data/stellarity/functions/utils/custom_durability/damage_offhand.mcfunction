...
#modify item
data modify storage stellarity:temp object set from entity @s Inventory[{Slot:-106b}]
...
item modify entity @s weapon.offhand stellarity:append_durability_lore
...
execute if score $player.out_0 stellarity.misc matches 0 run item replace entity @s weapon.offhand with minecraft:air
