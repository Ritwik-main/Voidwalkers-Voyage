...
#modify item
data modify storage stellarity:temp object set from entity @s Inventory[{Slot:100b}]
...
item modify entity @s armor.feet stellarity:append_durability_lore
...
execute if score $player.out_0 stellarity.misc matches 0 run item replace entity @s armor.feet with minecraft:air
