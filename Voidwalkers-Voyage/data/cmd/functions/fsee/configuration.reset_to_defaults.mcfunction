...
scoreboard players set #stellarity.config stellarity.config.change_gamerules 1
scoreboard players set #stellarity.config stellarity.config.always_generate_egg 1
